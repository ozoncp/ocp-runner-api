...
COPY . /home/developer/go/src/github.com/ozoncp/ocp-runner-api
RUN echo developer | sudo -S chown -R developer /home/developer/

WORKDIR /home/developer/go/src/github.com/ozoncp/ocp-runner-api
...
WORKDIR /root/
COPY --from=builder /home/developer/go/src/github.com/ozoncp/ocp-runner-api/bin/ocp-runner-api .
COPY --from=builder /home/developer/go/src/github.com/ozoncp/ocp-runner-api/config.yml .
RUN chown root:root ocp-runner-api
EXPOSE 7000-7010
CMD ["./ocp-runner-api"]
